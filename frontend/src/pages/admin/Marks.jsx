        ...
        const loadBase = async () => {
            ...
            try {
                const [studentPage, subjectList] = await Promise.all([
                    fetchStudents({ page: 0, size: 200, sortBy: 'name' }),
                    fetchSubjects(),
                ]);
    ...
    return (
        <div className="eg-page">
            <div className="eg-page-header">
                ...
                <h1 className="eg-page-title">Marks</h1>
                <p className="eg-page-subtitle">Select a student to view or manage their recorded marks.</p>
            </div>
              ...
              {selectedStudent ? `Marks — ${selectedStudent.name}` : 'Select a student'}
                    ...
                    {!selectedStudent && (
                        <div className="eg-empty">
                            ...
                            <p>Choose a student from the list to view their marks.</p>
                        </div>
                    )}
                ...
                <div className="eg-modal-overlay" onClick={() => setModalOpen(false)}>
                    <div className="eg-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
                        <div className="eg-modal-header">
                            <h3 style={{ fontSize: 18 }}>{editingMarks ? 'Edit marks' : 'Add marks'}</h3>
                        ...
                        <div className="eg-modal-body">
                            <MarksForm
                                ...
                                submitLabel={editingMarks ? 'Update marks' : 'Add marks'}
                            />
                        </div>
                    </div>
                </div>
